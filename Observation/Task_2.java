...
class Account {
	...
	Account(String n, int num, double bal, String t) {
		name = n;
		accountNo = num;
		balance = bal;
		type = t;
...
class SavingsAccount extends Account {
	...
	SavingsAccount(String name, int num, double bal, double r) {
		super("raju", num, bal, "savings account");
		rate = r;
	}
...
class CurrentAccount extends Account {
	...
	CurrentAccount(String name, int num, double bal, double l) {
		super("ramu", num, bal, "current account");
		limit = l;
	}
...
public class Task_2 {
	...
	public static void main(String[] args) {
		...
		SavingsAccount sav = new SavingsAccount("rahul", 100, 5000, 5);
		CurrentAccount cur = new CurrentAccount("kishore", 101, 3000, 2000);
